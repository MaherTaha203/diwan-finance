...
| CDS · OD‑03…05 | **Constitutional Decision Sessions (frozen)** — OD‑03: deterministic ordering (earliest‑first; tie‑break creation‑time→unique‑id; "Current‑Year"=org operating year). OD‑04: BO‑06 settlement (aggregate; deficit‑treasury funded; Law 9). OD‑05: refund first‑class (origin‑funded; prohibited after close; ≠ cancellation). Decision‑only (no code). | CA‑003 · ADR‑004/CA‑004 · ADR‑005/CA‑005 | *(this session)* |
