...
| OD‑06 | Credit lifecycle (expiry / cross‑year / cross‑program) | **OPEN** | — | (pending) |
...
passes. **5 of 7 frozen** (OD‑01…OD‑05). Remaining: OD‑06 (credit lifecycle) · OD‑07 (edge‑case ratifications).
