  ...
  const DuesWorkspace = {
    ...
    printView() {
      ...
      /* REPORT-001 — the unified engine is the sole print path (R8-b removed the
         ...
         REPORT_ENGINE_DUES_SNAPSHOT off, this surface no-ops rather than falling
         back — a surface can be disabled but there is no legacy path. */
      ...
      if (typeof window.toast === 'function') window.toast(T('طباعة الاشتراكات غير متاحة حاليًا', 'Dues print is currently unavailable'));
    }
  };
