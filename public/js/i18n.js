...
const translations = {
  ar: {
    ...
    stmt: {
      ...
      credit_tag:'(دائن)',
      member_label:'العضو:',
      active_since:'· ناشط من سنة',
      total_due:'إجمالي المستحق',
      total_paid:'إجمالي المدفوع',
      final_bal:'الرصيد النهائي',
      ref:'المرجع',
      col_due:'مستحق (مدين)',
      col_paid:'مدفوع (دائن)',
      ...
      total_donations:'إجمالي التبرعات',
      to_food:'موجّه للغداء',
      to_diwan:'موجّه للديوان',
      direction:'التوجيه',
