...
const translations = {
  ar: {
    ...
    receipts: {
      ...
      save_print:'حفظ وطباعة', save_only:'حفظ فقط',
      form_sub:'تسجيل إيصال قبض واحد',
      deficit_toggle:'تسوية عجز تاريخي (قرار المحاسب)',
      deficit_amount_ph:'0.00',
      don_kind:'نوع التبرّع',
      don_kind_cash:'نقدي — يدخل خزينة',
      don_kind_inkind:'عيني / خدمي — قيمة توثيقية (لا يدخل أي خزينة)',
      don_category:'فئة التبرّع العيني/الخدمي',
      confirm_title:'ما سيقوم به النظام عند الحفظ',
      member_position:'وضع العضو المالي',
    },
    payments: {
      fund:'الصندوق',
      ...
      form_sub:'تسجيل عملية صرف واحدة من الصندوق',
      grp_beneficiary:'بيانات المستفيد',
      grp_financial:'البيانات المالية',
      grp_notes:'الملاحظات / البيان',
    },
    donations: {
